...
//     <div
//       id="fullscreennav"
//       className="h-screen text-white py-40 w-full absolute  bg-amber-900"
//     >
//       <div className="">
//         <div className="link  relative bg-[#d3fd50] border-t-2 border-white">
...
//             <div className=" items-center overflow-auto flex  ">
//               <h2 className="whitespace-nowrap font-[font1] text-[5vw] text-center leading-[0.8] pt-10 uppercase">
//                 Pour Tout voir
//               </h2>
//               <img className="rounded-full h-32 w-80 object-cover shrink-0" src={bag} alt="" />
//              <h2 className="whitespace-nowrap font-[font1] text-[5vw] text-center leading-[0.8] pt-10 uppercase">
//                 Pour Tout voir
//               </h2>
//               <img className="rounded-full h-32 w-80 object-cover shrink-0" src={bike} alt="" />
//             </div>
//           </div>
//             <div className="absolute flex text-black top-0 bg-[#d3fd50]">
//             <div className=" items-center overflow-auto flex  ">
...
import { NavbarContext } from '../context/NavContext'   // ✅ CORRECT IMPORT

const FullScreenNav = () => {

    const [navOpen, setNavOpen] = useContext(NavbarContext) // ✅ REQUIRED
    ...
    return (
        <div ref={fullScreenRef} id='fullscreennav' className='fullscreennav hidden text-white overflow-hidden h-screen w-full z-50 absolute'>
            ...
            <div ref={fullNavLinksRef} className='relative'>
                ...
                {/* NAV TOP (LOGO + CLOSE) */}
                <div className="navlink opacity-0 flex w-full justify-between lg:p-5 p-2 items-start">
                    ...
                    <div className='link origin-top relative border-t-1 border-white'>
                        ...
                        <div className='moveLink absolute text-black flex top-0 bg-[#D3FD50]'>
                            <div className='moveX flex items-center'>
                                <h2 className='whitespace-nowrap font-[font2] lg:text-[8vw] text-5xl uppercase lg:pt-10 pt-4'>Pour Tout voir</h2>
